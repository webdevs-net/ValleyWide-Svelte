										...
										{#each portfolioList as project, index}				
											...
											<div class="masonry-items" in:fly id="masonry-items{index}" gsap-duration="1" gsap-delay={index/2} gsap-y="30"> 
												...
												<a data-sveltekit-reload href="/portfolio/{project.attributes.slug}" class="zoomImg">      
													...
													<img src="{domain}{project.attributes.featuredImage.data.attributes.formats.medium.url ? project.attributes.featuredImage.data.attributes.formats.medium.url : project.attributes.featuredImage.data.attributes.url}" alt="{project.attributes.title}" >   
													{:else}
				...
				<Col md="5" class="my-auto containerimg" >
					<div class="childimg">
						{#if home.reputation.image.data}
							<img in:fly2 id="reputation-img" src="{domain}{home.reputation.image.data.attributes.formats.medium.url ? home.reputation.image.data.attributes.formats.medium.url : home.reputation.image.data.attributes.url}" alt="{home.reputation.image.data.attributes.alternativeText}" >
						{/if}
					</div>
				</Col>
			</Row>
			...
			<Col md="6" class="">
				<div class="process__top-image childimg2" >
					{#if home.ourProcessTopImage.data}
						<img in:fly2 id="process-top-img" gsap-y="-60" src="{domain}{home.ourProcessTopImage.data[0].attributes.formats.medium.url ? home.ourProcessTopImage.data[0].attributes.formats.medium.url : home.ourProcessTopImage.data[0].attributes.url}" alt="{home.ourProcessTopImage.data[0].attributes.alternativeText}"/>
					{/if}
				</div>
			</Col>
		</Row>
			...
			<Col md="5" class="my-auto containerimg3">
				<div class="process__bottom childimg3">
					{#if home.ourProcessRightImage.data}
						<img in:fly2 id="process-bottom-img" gsap-y="-150" src="{domain}{home.ourProcessRightImage.data.attributes.formats.medium.url ? home.ourProcessRightImage.data.attributes.formats.medium.url : home.ourProcessRightImage.data.attributes.url}" alt="{home.ourProcessRightImage.data.attributes.alternativeText}">
					{/if}
				</div>
			</Col>
		</Row>
				...
				<Col md="5" class="my-auto containerimg4">
					<div class="childimg4">
						{#if home.ourStoryRightImage.data}
							<img in:fly2 id="story-img"  src="{domain}{home.ourStoryRightImage.data.attributes.formats.medium.url ? home.ourStoryRightImage.data.attributes.formats.medium.url : home.ourStoryRightImage.data.attributes.url}" alt="{home.ourStoryRightImage.data.attributes.alternativeText}">
						{/if}
					</div>	
				</Col>
			</Row>
