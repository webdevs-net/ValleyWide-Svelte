...
type LayoutRouteId = RouteId | "/" | "/about-us" | "/articles" | "/articles/[slug]" | "/clear" | "/contact-us" | "/home_old" | "/our-process" | "/our-team" | "/our-team/[slug]" | "/page" | "/page/[slug]" | "/portfolio" | "/portfolio/[slug]" | "/privacy" | "/services" | null
