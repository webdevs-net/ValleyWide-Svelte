...
<head>
    <meta charset="utf-8">
    <title>Source: flicking.js | egjs - API</title>
...
<li class="item" data-name="jQuery">
    ...
    <div class="main">
        <h1 class="page-title" data-filename="flicking.js.html">Source: flicking.js</h1>
    ...
    <section>
        <article>
            <pre class="prettyprint source linenums"><code>// jscs:disable validateLineBreaks, maximumLineLength
/**
